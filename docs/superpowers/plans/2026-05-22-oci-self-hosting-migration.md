...
- [x] **Step 2: channelRef → realtimeRef**
...
- [x] **Step 1: useMeteorGame import 교체**
...
- [x] **Step 2: useMeteorGame openLeaderboard 교체**
...
- [x] **Step 3: useMeteorGame 마운트 fetch 교체**
...
- [x] **Step 4: useMeteorGame gameover submit 교체**
...
- [x] **Step 5: useJumpGame import 교체**
...
- [x] **Step 6: useJumpGame openLeaderboard 교체**
...
- [x] **Step 7: useJumpGame 마운트 fetch 교체**
...
- [x] **Step 8: useJumpGame gameover submit 교체**
...
- [x] **Step 4: vitest 가 realtime-server 를 건드리지 않게 제외**
